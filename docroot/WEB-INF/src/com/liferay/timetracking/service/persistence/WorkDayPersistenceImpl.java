...
import com.liferay.timetracking.NoSuchWorkDayException;
import com.liferay.timetracking.model.WorkDay;
import com.liferay.timetracking.model.impl.WorkDayImpl;
import com.liferay.timetracking.model.impl.WorkDayModelImpl;
...
public class WorkDayPersistenceImpl extends BasePersistenceImpl<WorkDay>
	...
	@Override
	public WorkDay updateImpl(com.liferay.timetracking.model.WorkDay workDay)
	...
	protected WorkDay toUnwrappedModel(WorkDay workDay) {
		...
		workDayImpl.setLunchBreak(workDay.getLunchBreak());
		workDayImpl.setTimestamp(workDay.getTimestamp());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.timetracking.model.WorkDay")));
