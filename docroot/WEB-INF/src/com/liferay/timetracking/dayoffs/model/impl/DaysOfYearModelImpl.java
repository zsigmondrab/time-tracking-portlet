...
public class DaysOfYearModelImpl extends BaseModelImpl<DaysOfYear>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "ruleId", Types.BIGINT },
			{ "unitId", Types.BIGINT },
			{ "unitType", Types.INTEGER }
		};
	public static final String TABLE_SQL_CREATE = "create table TimeTracking_DaysOfYear (dayOfYearId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,dayId DATE null,ruleId LONG,unitId LONG,unitType INTEGER)";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
			...
			true);
	public static long DAYID_COLUMN_BITMASK = 1L;
	public static long DAYOFYEARID_COLUMN_BITMASK = 2L;
	public static long UNITID_COLUMN_BITMASK = 4L;
	public static long UNITTYPE_COLUMN_BITMASK = 8L;
	...
	public void setDayOfYearId(long dayOfYearId) {
		_columnBitmask |= DAYOFYEARID_COLUMN_BITMASK;

		if (!_setOriginalDayOfYearId) {
			_setOriginalDayOfYearId = true;

			_originalDayOfYearId = _dayOfYearId;
		}

		_dayOfYearId = dayOfYearId;
	}

	public long getOriginalDayOfYearId() {
		return _originalDayOfYearId;
	}
	...
	public void setUnitType(int unitType) {
		_columnBitmask |= UNITTYPE_COLUMN_BITMASK;

		if (!_setOriginalUnitType) {
			_setOriginalUnitType = true;

			_originalUnitType = _unitType;
		}

		_unitType = unitType;
	}

	public int getOriginalUnitType() {
		return _originalUnitType;
	}
	...
	public Object clone() {
		...
		daysOfYearImpl.setUnitId(getUnitId());
		daysOfYearImpl.setUnitType(getUnitType());
	...
	public void resetOriginalValues() {
		...
		daysOfYearModelImpl._originalDayOfYearId = daysOfYearModelImpl._dayOfYearId;

		daysOfYearModelImpl._setOriginalDayOfYearId = false;

		daysOfYearModelImpl._originalDayId = daysOfYearModelImpl._dayId;

		daysOfYearModelImpl._originalUnitId = daysOfYearModelImpl._unitId;

		daysOfYearModelImpl._setOriginalUnitId = false;

		daysOfYearModelImpl._originalUnitType = daysOfYearModelImpl._unitType;

		daysOfYearModelImpl._setOriginalUnitType = false;
	...
	public CacheModel<DaysOfYear> toCacheModel() {
		...
		daysOfYearCacheModel.unitId = getUnitId();

		daysOfYearCacheModel.unitType = getUnitType();
	...
	private long _originalDayOfYearId;
	private boolean _setOriginalDayOfYearId;
	...
	private int _originalUnitType;
	private boolean _setOriginalUnitType;
