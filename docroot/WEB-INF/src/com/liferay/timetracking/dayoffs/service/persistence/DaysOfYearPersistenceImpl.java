...
public class DaysOfYearPersistenceImpl extends BasePersistenceImpl<DaysOfYear>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(DaysOfYearModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			DaysOfYearModelImpl.COMPANYID_COLUMN_BITMASK |
			DaysOfYearModelImpl.DAYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(DaysOfYearModelImpl.ENTITY_CACHE_ENABLED,
			DaysOfYearModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the days of years where companyId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<DaysOfYear> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the days of years where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.timetracking.dayoffs.model.impl.DaysOfYearModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<DaysOfYear> findByCompanyId(long companyId, int start, int end)
		throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the days of years where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.timetracking.dayoffs.model.impl.DaysOfYearModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DaysOfYear> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (DaysOfYear daysOfYear : list) {
				if ((companyId != daysOfYear.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first days of year in the ordered set where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching days of year
	 ...
	 */
	@Override
	public DaysOfYear findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDaysOfYearException, SystemException {
		DaysOfYear daysOfYear = fetchByCompanyId_First(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public DaysOfYear fetchByCompanyId_First(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<DaysOfYear> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last days of year in the ordered set where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching days of year
	 ...
	 */
	@Override
	public DaysOfYear findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDaysOfYearException, SystemException {
		DaysOfYear daysOfYear = fetchByCompanyId_Last(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public DaysOfYear fetchByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<DaysOfYear> list = findByCompanyId(companyId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the days of years before and after the current days of year in the ordered set where companyId = &#63;.
	 *
	 * @param dayOfYearId the primary key of the current days of year
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DaysOfYear[] findByCompanyId_PrevAndNext(long dayOfYearId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, daysOfYear,
					companyId, orderByComparator, true);

			array[1] = daysOfYear;

			array[2] = getByCompanyId_PrevAndNext(session, daysOfYear,
	...
	protected DaysOfYear getByCompanyId_PrevAndNext(Session session,
		DaysOfYear daysOfYear, long companyId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the days of years where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (DaysOfYear daysOfYear : findByCompanyId(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(daysOfYear);
		}
	}
	...
	/**
	 * Returns the number of days of years where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the number of matching days of years
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "daysOfYear.companyId = ?";
	...
	public DaysOfYear updateImpl(
		...
		if (isNew || !DaysOfYearModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((daysOfYearModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						daysOfYearModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] { daysOfYearModelImpl.getCompanyId() };
