 ...
 * @generated
 */
public abstract class ActivityAssignmentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ActivityAssignmentActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ActivityAssignmentLocalServiceUtil.getService());
		setClass(ActivityAssignment.class);

		setClassLoader(com.liferay.timetracking.activities.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("activityAssignmentId");
	}
}