...
/**
 * Provides the local service interface for ActivityAssignment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Laszlo Hudak, Adam T. Nagy
 * @see ActivityAssignmentLocalServiceUtil
...
public interface ActivityAssignmentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActivityAssignmentLocalServiceUtil} to access the activity assignment local service. Add custom service methods to {@link com.liferay.timetracking.activities.service.impl.ActivityAssignmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
