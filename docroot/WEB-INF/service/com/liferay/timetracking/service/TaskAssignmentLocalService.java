...
/**
 * Provides the local service interface for TaskAssignment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BénaBéla
 * @see TaskAssignmentLocalServiceUtil
...
public interface TaskAssignmentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskAssignmentLocalServiceUtil} to access the task assignment local service. Add custom service methods to {@link com.liferay.timetracking.service.impl.TaskAssignmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
