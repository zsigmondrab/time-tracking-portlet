 ...
 * @generated
 */
public abstract class TaskAssignmentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TaskAssignmentActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TaskAssignmentLocalServiceUtil.getService());
		setClass(TaskAssignment.class);

		setClassLoader(com.liferay.timetracking.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("taskAssignmentId");
	}
}