...
/**
 * Provides the local service interface for DaysOfYear. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LÃ¡szlÃ³ HudÃ¡k
 * @see DaysOfYearLocalServiceUtil
...
public interface DaysOfYearLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DaysOfYearLocalServiceUtil} to access the days of year local service. Add custom service methods to {@link com.liferay.timetracking.dayoffs.service.impl.DaysOfYearLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
