 ...
 * @generated
 */
public abstract class DaysOffCounterActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DaysOffCounterActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DaysOffCounterLocalServiceUtil.getService());
		setClass(DaysOffCounter.class);

		setClassLoader(com.liferay.timetracking.dayoffs.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("dayOffCounterId");
	}
}