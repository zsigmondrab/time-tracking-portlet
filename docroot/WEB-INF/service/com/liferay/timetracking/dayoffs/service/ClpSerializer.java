...
public class ClpSerializer {
	...
	public static Object translateInputDaysOfYear(BaseModel<?> oldModel) {
		DaysOfYearClp oldClpModel = (DaysOfYearClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getDaysOfYearRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
			...
			return translateOutputDaysOfYear(oldModel);
		}
	...
	public static Object translateOutputDaysOfYear(BaseModel<?> oldModel) {
		DaysOfYearClp newModel = new DaysOfYearClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setDaysOfYearRemoteModel(oldModel);
